...
class GameScene(Scene):
    ...
    def update(self):
        ...
        for missile in self.missiles:
            if missile.position.y > self.size_of_screen.y + 200:
        ...
        for alien in self.aliens:
            if alien.position.y < -150:
                ...
                self.missiles.remove(missile)
        #check every update to see if missile touches alien
            ...
            for alien in self.aliens:
                for missile in self.missiles:
                    if alien.frame.contains_rect(missile.frame):
                        ...
                        #since an alien was destroyed make another show up
